...
`npm run check:all` to verify all builds, contracts, services, saga flows, messaging,
recovery, and process/broker crash scenarios. System tests manage an isolated Docker broker.
