...
// Create instances of the order service, recovery worker, and messaging worker, and start the messaging and recovery processes. Set up signal handlers for graceful shutdown of the service.
