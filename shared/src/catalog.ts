...
export const catalog = [
  { id: '44444444-4444-4444-8444-444444444444', sku: 'KEYBOARD-01', name: 'Keyboard', priceMinor: 250000 },
  { id: '55555555-5555-4555-8555-555555555555', sku: 'MOUSE-01', name: 'Mouse', priceMinor: 85000 },
  { id: '66666666-6666-4666-8666-666666666666', sku: 'MONITOR-01', name: 'Monitor', priceMinor: 3200000 },
] as const;
